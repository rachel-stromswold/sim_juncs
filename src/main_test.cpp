...
TEST_CASE("Test context file parsing") {
    ...
    value inst = c.peek(4).get_val();
	CHECK(inst.type == VAL_INST);
	CHECK(inst.val.c->size() == 8);
	name_val_pair tmp_p = inst.val.c->peek(0);
	CHECK(tmp_p.name_matches("type"));
	CHECK(tmp_p.get_val().type == VAL_STR);
	CHECK(strcmp(tmp_p.get_val().val.s, "Gaussian") == true);
    ...
    inst = c.peek(3).get_val();
	CHECK(inst.type == VAL_INST);
	CHECK(inst.val.c->size() == 8);
	tmp_p = inst.val.c->peek(0);
	CHECK(tmp_p.name_matches("type"));
	CHECK(tmp_p.get_val().type == VAL_STR);
	CHECK(strcmp(tmp_p.get_val().val.s, "Composite") == true);
	...
	CHECK(inst.val.c->peek().get_val().type == VAL_INST);
	CHECK(inst.val.c->peek().get_val().val.c->size() == 1);
    inst = c.peek(1).get_val();
	CHECK(inst.type == VAL_INST);
	CHECK(inst.val.c->size() == 8);
	tmp_p = inst.val.c->peek(0);
	CHECK(tmp_p.name_matches("type"));
	CHECK(tmp_p.get_val().type == VAL_STR);
	CHECK(strcmp(tmp_p.get_val().val.s, "snapshot") == true);
