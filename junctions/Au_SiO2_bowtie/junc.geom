...
data(type = "monitor", locations = [vec(x, ofa, top-0.05*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.05*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.10*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.15*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.20*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.25*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.30*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.35*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.40*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.45*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.50*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.55*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.60*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.65*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.70*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.75*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.80*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.85*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.90*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
data(type = "monitor", locations = [vec(x, ofa, top+0.95*meep_thick) for x in linspace(mon_start, mid, 20)]) {}
